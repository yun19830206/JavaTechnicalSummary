...
public class RestTemplateUtils {
    ...
    public static <T> T get(RestTemplate restTemplate, String requestUrl, Object request, Class<T> responseType) {
        log.debug("RestTemplateUtils Get Start for url：{}, request object is:{}",requestUrl,request);
...
//        httpHeaders.put(HttpHeaders.COOKIE,cookies);
        ...
        log.debug("RestTemplateUtils Get End for url：{}, response object is:{}",requestUrl,t);
        return t ;
    }
}
