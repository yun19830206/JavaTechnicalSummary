package com.cloud.stagging.core.cache.impl;
...
public class RedisCacheImpl implements ICacheInterface {
    ...
    public void setMapDemo(){
        /** 报错验证不成功：java.lang.ClassCastException: com.cloud.stagging.stagging.pojo.User cannot be cast to java.lang.String */
