package com.cloud.experience.spring.httprequest;
...
public class GetHttpRequestParamValueDemo {
    ...
    private static String logString = "请求参数中User对象为：" ;
    ...
    public AjaxResponse addUserByServletRequest(HttpServletRequest request){
        User user = new User(request.getParameter("name"),Long.parseLong(request.getParameter("age")));
        log.debug(logString +user);
    ...
    public AjaxResponse addUserByKeyByKey(String name, int age){
        User user = new User(name, (long) age);
        log.debug(logString +user);
        return AjaxResponse.success(user);
    }
    ...
    public AjaxResponse addUserByBeanUseRequestBody(@RequestBody User user){
        log.debug(logString +user.toString());
        return AjaxResponse.success(user);
    }
    ...
    public AjaxResponse addUserByPathValue(@PathVariable String useName, @PathVariable("userAge") int age){
        User user = new User(useName, (long) age);
        log.debug(logString +user);
        return AjaxResponse.success(user);
    }
    ...
    public AjaxResponse addUserByRequestParam(@RequestParam("name") String userName,
        ...
        User user = new User(userName, (long) userAge);
        log.debug(logString +user);
        return AjaxResponse.success(user);
    }
